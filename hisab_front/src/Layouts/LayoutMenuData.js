...
const Navdata = () => {
  ...
  const [isBankAccounts, setIsBankAccounts] = useState(false);
  const [isExpenses, setIsExpenses] = useState(false);
  const [isIncome, setIsIncome] = useState(false);
  const [isBankTransfers, setIsBankTransfers] = useState(false);
  ...
  useEffect(() => {
    ...
    if (iscurrentState !== "BankAccounts") {
      setIsBankAccounts(false);
    }
    if (iscurrentState !== "Expenses") {
      setIsExpenses(false);
    }
    if (iscurrentState !== "Income") {  // New effect for Income
      setIsIncome(false);
    }
    if (iscurrentState !== "BankTransfers") {
      setIsBankTransfers(false);
    }
    if (iscurrentState !== "UserManagement") { // New effect for User Management
      setIsUserManagement(false);
    }
    if (iscurrentState !== "Products") { // New effect for Products
      setIsProducts(false);
    }
  ...
  const menuItems = [
    ...
    // },
    {
      id: "contacts",
      label: "Contacts",
      icon: "las la-address-book", // Appropriate icon for contacts
      link: "/contacts",
      click: function (e) {
        e.preventDefault();
    ...
    },
    {
      ...
      click: function (e) {
        e.preventDefault();
        setIsBankAccounts(!isBankAccounts);
        setIscurrentState("BankAccounts");
        updateIconSidebar(e);
      },
      stateVariables: isBankAccounts
    },
    {
      id: "products",
      label: "Products",
    ...
    },
    {
      id: "purchases",
      label: "Purchases",
      icon: "las la-shopping-cart", // Appropriate shopping cart icon
      link: "/purchases",
      click: function (e) {
        e.preventDefault();
    ...
    },
    {
      id: "sales",
      label: "Sales",
      icon: "las la-cash-register", // Appropriate cash register icon
      link: "/sales",
      click: function (e) {
        e.preventDefault();
        setIsSales(!isSales);
    ...
    },
    {
      id: "income",
      label: "Income",
      icon: "las la-money-bill-wave",  // Appropriate icon for income
      link: "/income",
      click: function (e) {
        e.preventDefault();
        setIsIncome(!isIncome);
        setIscurrentState("Income");
        updateIconSidebar(e);
      },
      stateVariables: isIncome
    },
    {
      id: "expenses",
      label: "Expenses",
    ...
    },
    {
      ...
      icon: "las la-exchange-alt",  // Using exchange icon for transfers
      link: "/bank-transfers",
      click: function (e) {
        e.preventDefault();
        setIsBankTransfers(!isBankTransfers);
        setIscurrentState("BankTransfers");
        updateIconSidebar(e);
      },
      stateVariables: isBankTransfers
    },
    {
      id: "payments",
      label: "Payments",
      icon: "las la-credit-card", // Appropriate credit card icon
      link: "/payments",
      click: function (e) {
        e.preventDefault();
